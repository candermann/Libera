      ...
      {benachrichtigungen.length === 0 ? (
        ...
        <div key={b.typ} style={{ padding: '14px 16px', borderTop: i === 0 ? 'none' : '1px solid #f8fafc' }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
            <div style={{ width: 32, height: 32, borderRadius: 8, background: b.typ === 'schuljahr_wechsel' ? '#eff6ff' : '#fef3c7', color: b.typ === 'schuljahr_wechsel' ? '#1d4ed8' : '#b45309', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {b.typ === 'schuljahr_wechsel' && (
                ...
                >
                  <Icon name="settings" size={12}/> Zu den Einstellungen
                </button>
              )}
            </div>
          </div>
  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: 1180, margin: '0 auto' }}>
      <div style={{ marginBottom: 28, display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        ...
        <style>{`@keyframes glocke-pulse{0%,100%{box-shadow:0 0 0 0 rgba(245,158,11,0.5)}50%{box-shadow:0 0 0 6px rgba(245,158,11,0)}}`}</style>
